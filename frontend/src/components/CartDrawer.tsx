...
import OrderTracker, { parsePrice, type OrderData, Spin, getApiError } from './OrderTracker'
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {orderConfirmation ? 'Order Placed!' : `Your Cart (${items.length})`}
          </h2>
        ...
        >
          {orderConfirmation ? (
            ...
            <div className="space-y-5">
                  ...
                  {orderConfirmation.items.map((item) => (
                    ...
                    >
                      <span style={{ color: '#1A1410', fontSize: '0.9rem' }}>
                        {item.name}{' '}
                        <span style={{ color: '#A09080' }}>×{item.quantity}</span>
                      </span>
                      <span
                        style={{
                          fontWeight: 600,
              ...
              <p style={{ fontSize: '0.75rem', textAlign: 'center', color: '#A09080', marginTop: '8px' }}>
                  ...
                  {items.map((item) => (
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <p style={{ fontSize: '0.8rem', color: '#A09080', margin: '2px 0 0' }}>
                      ...
                      <button
                        ...
                        onMouseEnter={(e) => { e.currentTarget.style.color = accent; }}
                        onMouseLeave={(e) => { e.currentTarget.style.color = '#D1C9BF'; }}
                      >
                        ×
                      </button>
                    </li>
            ...
            <>
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 700,
                  fontSize: '1rem',
                  cursor: items.length === 0 || placing ? 'not-allowed' : 'pointer',
                  transition: 'all 0.15s ease',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  gap: '8px',
                  fontFamily: 'DM Sans, sans-serif',
                  backgroundColor: items.length === 0 || placing ? '#D1C9BF' : accent,
                  transform: items.length > 0 && !placing ? 'translateY(0)' : 'none',
                }}
                onMouseEnter={(e) => {
                  if (items.length > 0 && !placing) {
                    e.currentTarget.style.backgroundColor = accentHover;
                    e.currentTarget.style.transform = 'translateY(-1px)';
                    e.currentTarget.style.boxShadow = '0 4px 12px rgba(212,59,31,0.25)';
                  }
                }}
                onMouseLeave={(e) => {
                  if (items.length > 0 && !placing) {
              ...
              >
                {placing ? <><Spin className="h-5 w-5" /> Placing Order...</> : 'Place Order'}
              </button>
            </>
          )}
        </div>
